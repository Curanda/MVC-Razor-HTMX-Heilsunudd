...
namespace Heilsunudd.Intranet.Controllers
{
    public class AboutUsController : Controller
    {
        ...
        public AboutUsController(HeilsunuddDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var aboutUs = await _context.AboutUs
                .FirstOrDefaultAsync(m => m.IdAboutUs == id);
            if (aboutUs == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("IdAboutUs,Title,Content,ImageUrl,Position")] AboutUs aboutUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAboutUs,Title,Content,ImageUrl,Position")] AboutUs aboutUs)
        {
        ...
        {
            return _context.AboutUs.Any(e => e.IdAboutUs == id);
        }
    }
}
